...
//        manager.cancelImageRequest(pId)
    ...
    static func getAssets(allowMediaTypes: [FMMediaType], includeAssetSourceTypes: PHAssetSourceType) -> [PHAsset] {
        let fetchOptions = PHFetchOptions()
        fetchOptions.includeAssetSourceTypes = includeAssetSourceTypes
